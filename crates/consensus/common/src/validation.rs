...
pub const LEGACY_MAX_RLP_BLOCK_SIZE: usize = 8_388_608;

/// For Fluent max RLP block size is reduced to fit into BLOBs better
pub const MAX_RLP_BLOCK_SIZE: usize = 1_835_008;
